...
struct BraceletsView_Previews: PreviewProvider {
    static var previews: some View {
        BraceletsView(restaurant: PostModel(id: "", category: "", items: [ItemModel(id: "", description: "", company: "", companystyle: "", style: "", category: "", notes: "", price: "", priceopt: "", hidden: false, favorite: false, image: "", images: [""])]), category: "")
